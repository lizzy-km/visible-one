        ...
        onDrag={()=>{
         ...
         onClick={()=>{
          ...
          <div className=' flex justify-end items-center w-[100%] h-full  '>
            <img className=' h-[146.1px] mt-[14px] pr-[-60px]  ' src="https://cdn-sharing.adobecc.com/content/storage/id/urn:aaid:sc:US:44b7b4d2-e03d-4e25-8fa0-35fcbb2b490f;revision=0?component_id=19a053e0-68aa-4b1d-8e6a-4cbdc7db6ce7&api_key=CometServer1&access_token=1691074605_urn%3Aaaid%3Asc%3AUS%3A44b7b4d2-e03d-4e25-8fa0-35fcbb2b490f%3Bpublic_d945895615534b19a96f44895df8b28a12aaf9cb" alt=""/>
          </div>
